...
<head>
    ...
    <link rel="stylesheet" href="\public\css\Atividade\pre-atividade\nav.css">
    <link rel="stylesheet" href="\public\css\Atividade\pre-atividade\painel.css">
</head>
<body>
  <div class="container">
    <div class="box">
      <div class="row tow d-flex justify-content-center align-items-center">
        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
              ...
              <div class="carousel-inner">
                @foreach($cards as $key)
                  <div class="carousel-item  @if($loop->index == 0) active @endif">
                    ...
                    <div class="row one">
                      <div class="cardup">
                        <h3 class="elemento text-center">{{$key->title}}</h3>
                      </div>
                    </div>
                  </div>
                @endforeach
          ...
          <button class="btn btn-primary btn-lg" onclick="window.location.href='/module/{{$slug}}/{{$num}}/quizz'" class="btn1">PLAY</button>  
        </div>    
      </div>
    </div>
  </div>
